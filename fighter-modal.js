  ...
  function injectCSS() {
    ...
    s.textContent = `
      ...
      .fm-nickname {
        ...
        color: rgba(217,123,63,0.7); margin-bottom: 3px;
      }
      .fm-name {
      ...
      .fm-division {
        ...
        border: 1px solid rgba(217,123,63,0.22);
      ...
      .fm-wb-dec { background: rgba(217,123,63,0.08);  color: rgba(217,123,63,0.6);  border: 1px solid rgba(217,123,63,0.14); }
      ...
      .fm-mb-dec { background: rgba(217,123,63,0.08);  color: rgba(217,123,63,0.65); }
      ...
      .fm-full-link {
        ...
        letter-spacing: 0.1em; text-transform: uppercase;
        color: rgba(217,123,63,0.55);
        text-decoration: none;
        transition: color 0.15s;
      }
      .fm-full-link:hover { color: #d97b3f; }
      .fm-no-history {
      ...
      .fm-full-link-inline {
        font-size: 0.58rem; color: rgba(217,123,63,0.45);
        text-decoration: none; transition: color 0.15s;
      }
      .fm-full-link-inline:hover { color: #d97b3f; }

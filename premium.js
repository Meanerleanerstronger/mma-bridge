...
body{
  background-image:
    radial-gradient(ellipse 60% 35% at 85% 100%,rgba(255,138,61,0.02) 0%,transparent 55%)
    !important;
}
...
.nav-links li a.active{
  ...
  text-shadow:0 0 20px rgba(255,138,61,0.75),0 0 50px rgba(255,138,61,0.3),0 0 8px rgba(255,138,61,0.3) !important;
}
...
.nav-logo-img:hover{
  ...
  filter:brightness(1.15) drop-shadow(0 0 8px rgba(255,138,61,0.4)) !important;
}
...
#heroSection::after{
  ...
  background:radial-gradient(ellipse 45% 45% at 65% 50%,rgba(255,138,61,0.025) 0%,transparent 70%);
}
#heroBtn{
...
#heroBtn:hover{
  ...
  box-shadow:0 8px 32px rgba(255,138,61,0.45),0 0 0 4px rgba(255,138,61,0.1) !important;
}
...
.result-card:hover{
  ...
  box-shadow:0 18px 48px rgba(0,0,0,0.7),0 0 0 1px rgba(255,138,61,0.12) !important;
  border-color:rgba(255,138,61,0.15) !important;
}
...
.news-card:hover,.trending-card:hover{
  ...
  border-color:rgba(255,138,61,0.18) !important;
}
...
#liveFeed{
  ...
  border:1px solid rgba(255,255,255,0.06) !important;
  box-shadow:0 0 0 1px rgba(255,138,61,0.04),0 20px 60px rgba(0,0,0,0.5) !important;
}
...
.ev-card.fn:hover{box-shadow:0 20px 60px rgba(0,0,0,0.75),0 0 0 1px rgba(255,138,61,0.1) !important;}
.ev-card.ppv:hover{box-shadow:0 20px 60px rgba(0,0,0,0.75),0 0 0 1px rgba(255,138,61,0.12) !important;}
...
.ov-fight:hover{
  background:rgba(255,138,61,0.025) !important;
  box-shadow:inset 3px 0 0 rgba(255,138,61,0.5) !important;
}
...
.search-box input:focus{
  box-shadow:0 0 0 1.5px rgba(255,138,61,0.4),0 4px 20px rgba(255,138,61,0.1) !important;
}
...
function initCursorGlow(){
  ...
  document.addEventListener('mouseover',function(e){
    ...
    if(e.target.closest('a,button,.ev-card,.review-card,.result-card,.news-card')){
      ...
      g.style.background='radial-gradient(circle,rgba(255,138,61,0.05) 0%,transparent 65%)';
    }
  });
  document.addEventListener('mouseout',function(e){
    ...
    if(e.target.closest('a,button,.ev-card,.review-card,.result-card,.news-card')){
      ...
      g.style.background='radial-gradient(circle,rgba(255,138,61,0.05) 0%,transparent 70%)';
    }
  });
}
initCursorGlow();
...
document.addEventListener('click',function(e){
  ...
  rpl.style.cssText='position:absolute;border-radius:50%;pointer-events:none;'+
    ...
    'background:rgba(255,138,61,0.18);transform:scale(0);'+

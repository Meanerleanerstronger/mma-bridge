...
(function () {
  ...
  function buildDOM() {
    ...
    elGlow = make('div');
    css(elGlow, { position:'fixed', zIndex:'9981', pointerEvents:'none', border:'1.5px solid rgba(242, 96, 15,.5)', borderRadius:'10px', boxShadow:'0 0 0 1px rgba(242, 96, 15,.1),0 0 40px rgba(242, 96, 15,.18)', transition:'all .42s cubic-bezier(.4,0,.2,1)', opacity:'0', animation:'trGlowPulse 2.4s ease-in-out infinite' });
    ...
    elBar = make('div');
    css(elBar, { height:'100%', width:'0%', background:'linear-gradient(90deg,#c98a00,#f2600f,#ffd960)', transition:'width .5s ease' });
  ...
  function injectCSS() {
    ...
    s.textContent = `
      @keyframes trGlowPulse {
        0%,100%{box-shadow:0 0 0 1px rgba(242, 96, 15,.1),0 0 28px rgba(242, 96, 15,.12)}
        50%{box-shadow:0 0 0 1px rgba(242, 96, 15,.28),0 0 50px rgba(242, 96, 15,.24)}
      }
      ...
      #trEndBtn {
        ...
        background:rgba(242, 96, 15,.12); border:1.5px solid rgba(242, 96, 15,.5);
        color:rgba(242, 96, 15,.95); font-family:'Montserrat',sans-serif;
        ...
        box-shadow:0 2px 16px rgba(242, 96, 15,.1);
      }
      #trEndBtn:hover{
        background:rgba(242, 96, 15,.22); border-color:rgba(242, 96, 15,.8);
        color:#f2600f; box-shadow:0 4px 24px rgba(242, 96, 15,.22);
      ...
      #trBubble {
        ...
        border:1px solid rgba(242, 96, 15,.16); border-radius:14px; padding:18px 20px;
      ...
      #trBubbleAv{
        ...
        background:linear-gradient(135deg,#f2600f,#c98a00);
      ...
      #trOffer{
        ...
        border:1px solid rgba(242, 96, 15,.2);border-radius:16px;padding:24px 26px;
      ...
      #trFakeRev{
        ...
        background:linear-gradient(135deg,rgba(8,10,18,.97),rgba(16,18,28,.95));
        border:1px solid rgba(242, 96, 15,.18);border-radius:12px;padding:16px 18px;
      ...
      .trfr-avg{font-family:'Barlow Condensed',sans-serif;font-size:2rem;font-weight:900;color:#f2600f;line-height:1}
      ...
      .trfr-who{color:#f2600f;font-weight:700;margin-right:4px}

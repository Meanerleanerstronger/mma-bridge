(function () {
  ...
  style.textContent = `
    ...
    #lw-widget.lw-dragging {
      ...
      box-shadow: 0 16px 48px rgba(0,0,0,0.75), 0 0 0 1px rgba(217,123,63,0.12) !important;
    }
    ...
    #lw-tab:hover {
      ...
      border-color: rgba(217,123,63,0.2);
    }
    #lw-tab-dot {
      width: 7px;
      height: 7px;
    ...
    @keyframes lwPulse {
      0%,100% { box-shadow: 0 0 0 0 rgba(217,123,63,0.5); opacity:1; }
      50%      { box-shadow: 0 0 0 5px rgba(217,123,63,0); opacity:0.7; }
    }
    #lw-close {
      background: none;
      border: none;
